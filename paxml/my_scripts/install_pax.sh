...
git clone -b xd/dev https://github.com/Lisennlp/mesh_easy_jax.git
mv mesh_easy_jax  /home/lishengping/projects/

# lsp
cd projects/
git clone -b xd/dev https://github.com/xiaoda99/paxml.git
git clone -b xd/dev https://github.com/xiaoda99/praxis.git
