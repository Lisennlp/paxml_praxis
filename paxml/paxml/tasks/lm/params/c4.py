...
GPT_SPM_PATH = (
    'gs://common_datasets_us-east5/vocab/c4_en_301_5Mexp_spm.model'
)
GPT_EOS_ID = 1
...
C4_TRAIN_DATADIR = 'gs://common_datasets_us-east5'
C4_EVAL_DATADIR = 'gs://common_datasets_us-east5'
